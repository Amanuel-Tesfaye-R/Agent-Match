...
export function HeroSection() {
  ...
  return (
    <div className="hero flex flex-col items-center justify-center text-center py-16 gap-6">
      ...
      <div className="fade-in flex flex-col items-center gap-2 w-full max-w-[520px]">
